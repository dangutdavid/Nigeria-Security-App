...
const SEED_REPORTS: CrimeReport[] = [
  ...
  {
    id: "cr-006",
    caseNumber: "NPF/ENO/2026/031",
    crimeType: "kidnapping",
    severity: "critical",
    status: "open",
    title: "Missing commuter reported after night trip",
    description: "Family reports commuter has not arrived after boarding an interstate vehicle. Last phone location near Ninth Mile.",
    location: "Ninth Mile, Enugu",
    state: "Enugu",
    lga: "Udi",
    latitude: 6.4491,
    longitude: 7.3982,
    ...
    reportedBy: "p1",
    reportedByName: "Insp. Chukwuemeka Okonkwo",
    notes: "Phone carrier trace requested.",
  },
  {
    id: "cr-007",
    caseNumber: "NPF/OYO/2026/018",
    crimeType: "cybercrime",
    severity: "moderate",
    status: "investigating",
    title: "Phishing ring targeting students",
    description: "Multiple victims received school fee payment links that redirected to fraudulent accounts.",
    location: "Agbowo, Ibadan",
    state: "Oyo",
    lga: "Ibadan North",
    latitude: 7.443,
    longitude: 3.9015,
    suspects: [{ id: "s6", description: "Account mule identified through bank KYC", status: "at_large" }],
    evidence: [{ id: "ev1", label: "Screenshot bundle" }],
    reportedAt: hrsAgo(14),
    reportedBy: "p2",
    reportedByName: "DSP Aisha Ibrahim",
    notes: "Cybercrime desk reviewing wallet movements.",
  },
  {
    id: "cr-008",
    caseNumber: "NPF/EDO/2026/044",
    crimeType: "arson",
    severity: "serious",
    status: "closed",
    title: "Shop fire after suspected arson",
    description: "Witnesses reported a suspect pouring fuel near a locked electronics shop before fire outbreak.",
    location: "Ring Road Market, Benin City",
    state: "Edo",
    lga: "Oredo",
    latitude: 6.335,
    longitude: 5.6037,
    suspects: [{ id: "s7", description: "Former employee arrested after CCTV review", status: "arrested" }],
    evidence: [{ id: "ev2", label: "CCTV extract" }],
    reportedAt: daysAgo(10),
    reportedBy: "p3",
    reportedByName: "ACP Daniel Eze",
    closedAt: daysAgo(6),
    notes: "Case file transferred for prosecution.",
  },
];
